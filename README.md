...
The current local profile example is:
...
The project includes a read-only public profile for Sarah with built-in journey data and photos. The `user` query parameter determines which profile is displayed. For example, `profile.html?user=sarah` displays Sarah's profile, while an unsupported user displays the invalid-profile state.

## Screenshots

- Homepage: `[Screenshot placeholder]`
- Add Trip / Journey Cards: `[Screenshot placeholder]`
- Public Profile: `[Screenshot placeholder]`
...
https://github.com/saraharshad101-sarah/Wanderlog
